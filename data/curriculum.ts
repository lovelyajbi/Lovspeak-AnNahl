    ...
    units: [
      {
        ...
        steps: [
          ...
          { id: 'a1-u1-s2', title: 'Reading: Meeting People', type: 'reading_task', moduleView: AppView.READING, description: 'Short dialogues about first meetings.', goal: '80% comprehension.', promptContext: 'Sarah meeting Budi for the first time at an Islamic conference.', targetId: 'a1-social-01' },
      ...
      },
      {
        ...
        steps: [
          ...
          { id: 'a1-u2-s2', title: 'Listening: What time is it?', type: 'listening_task', moduleView: AppView.LISTENING, description: 'Identifying time and dates in conversation.', goal: 'Catch specific details.', promptContext: 'Two people scheduling a community meeting at the mosque.', targetId: 'a1-daily-02' },
      ...
      },
      {
        ...
        steps: [
          ...
          { id: 'a1-u3-s2', title: 'Reading: My Big Family', type: 'reading_task', moduleView: AppView.READING, description: 'A story about helping elders.', goal: 'Identify family roles.', promptContext: 'A story about a grandson helping his grandfather prepare for Friday prayer.', targetId: 'a1-social-03' },
      ...
      },
      {
        ...
        steps: [
          ...
          { id: 'a1-u4-s3', title: 'Listening: Finding the Item', type: 'listening_task', moduleView: AppView.LISTENING, description: 'Follow directions inside a house.', goal: 'Locate the object.', promptContext: 'A guest asking for the prayer mat in a new house.', targetId: 'a1-daily-04' },
        ]
      },
      {
        ...
        steps: [
          ...
          { id: 'a1-u5-s2', title: 'Reading: A Muslim\'s Day', type: 'reading_task', moduleView: AppView.READING, description: 'Routine including prayer times.', goal: 'Sequence actions.', promptContext: 'Read about Ahmad waking up for Fajr and his daily work schedule.', targetId: 'a1-daily-05' },
      ...
      },
      {
        ...
        steps: [
          ...
          { id: 'a1-u6-s2', title: 'Reading: Halal Dining', type: 'reading_task', moduleView: AppView.READING, description: 'Menu analysis and healthy choices.', goal: 'Categorize food items.', promptContext: 'Read about choosing healthy and halal options in a global city.', targetId: 'a1-daily-06' },
      ...
      },
      {
        ...
        steps: [
          ...
          { id: 'a1-u7-s2', title: 'Listening: Office Introduction', type: 'listening_task', moduleView: AppView.LISTENING, description: 'Meeting new colleagues.', goal: 'Identify job titles.', promptContext: 'A dialogue where Person A asks Person B about their job and workplace.', targetId: 'a1-work-07' },
      ...
      },
      {
        ...
        steps: [
          ...
          { id: 'a1-u8-s2', title: 'Listening: Choosing Eid Clothes', type: 'listening_task', moduleView: AppView.LISTENING, description: 'Describing colors and styles.', goal: 'Match items to descriptions.', promptContext: 'A parent and child discussing which clothes to buy for the holiday.', targetId: 'a1-daily-01' },
      ...
      },
      {
        ...
        steps: [
          ...
          { id: 'a1-u9-s2', title: 'Reading: Sunnah Sports', type: 'reading_task', moduleView: AppView.READING, description: 'Archery, swimming, and more.', goal: 'Identify benefits.', promptContext: 'Read about the importance of physical fitness in Islamic tradition.', targetId: 'a1-social-02' },
      ...
      },
      {
        ...
        steps: [
          ...
          { id: 'a1-u10-s1', title: 'Reading: At the Doctor', type: 'reading_task', moduleView: AppView.READING, description: 'Explaining symptoms and check-ups.', goal: 'Understand symptoms.', promptContext: 'A young man describing a headache and fever to a clinic nurse.', targetId: 'a1-health-03' },
          { id: 'a1-u10-s2', title: 'Listening: Healthy Habits', type: 'listening_task', moduleView: AppView.LISTENING, description: 'Tips for a healthy body.', goal: 'Identify advice.', promptContext: 'A lecture about keeping a clean and healthy lifestyle.', targetId: 'a1-health-03' },
    ...
    units: [
      {
        ...
        steps: [
          ...
          { id: 'a2-u1-s2', title: 'Reading: Trip to Mecca', type: 'reading_task', moduleView: AppView.READING, description: 'A travel memoir of Umrah.', goal: 'Sequence history.', promptContext: 'Read about Musa\'s spiritual journey to the holy cities last Ramadan.', targetId: 'a2-travel-01' },
      ...
      },
      {
        ...
        steps: [
          ...
          { id: 'a2-u2-s2', title: 'Listening: At the Market', type: 'listening_task', moduleView: AppView.LISTENING, description: 'Negotiating prices and quality.', goal: 'Identify best value.', promptContext: 'A man comparing two sets of prayer beads in a traditional market.', targetId: 'a2-daily-02' },
      ...
      },
      {
        ...
        steps: [
          ...
          { id: 'a2-u3-s2', title: 'Reading: Old Village Stories', type: 'reading_task', moduleView: AppView.READING, description: 'Vivid childhood descriptions.', goal: 'Identify background actions.', promptContext: 'What was happening when the grand storm hit the village?', targetId: 'a2-social-03' },
      ...
      },
      {
        ...
        steps: [
          ...
          { id: 'a2-u4-s2', title: 'Reading: Success Stories', type: 'reading_task', moduleView: AppView.READING, description: 'Ambitions and long-term plans.', goal: 'Find future intents.', promptContext: 'Read about a student planning to serve their community as a doctor.', targetId: 'a2-work-04' },
      ...
      },
      {
        ...
        steps: [
          ...
          { id: 'a2-u5-s2', title: 'Listening: Extreme Climate News', type: 'listening_task', moduleView: AppView.LISTENING, description: 'Reporting on global geography.', goal: 'Identify locations.', promptContext: 'A report on the hottest desert and the deepest ocean.', targetId: 'a2-nature-05' },
      ...
      },
      {
        ...
        steps: [
          ...
          { id: 'a2-u6-s2', title: 'Reading: App Reviews', type: 'reading_task', moduleView: AppView.READING, description: 'Feedback on educational gadgets.', goal: 'Find life experiences.', promptContext: 'Read about people sharing their experiences using English apps.', targetId: 'a2-technology-06' },
      ...
      },
      {
        ...
        steps: [
          ...
          { id: 'a2-u7-s2', title: 'Reading: Etiquette (Adab)', type: 'reading_task', moduleView: AppView.READING, description: 'Social manners in various cultures.', goal: 'Identify habits.', promptContext: 'Read about always being polite and never ignoring a neighbor.', targetId: 'a2-social-07' },
      ...
      },
      {
        ...
        steps: [
          ...
          { id: 'a2-u8-s2', title: 'Listening: Moving House', type: 'listening_task', moduleView: AppView.LISTENING, description: 'A landlord-tenant dialogue.', goal: 'Identify house rules.', promptContext: 'Listen to a landlord telling a new tenant what they must not do.', targetId: 'a2-daily-01' },
      ...
      },
      {
        ...
        steps: [
          ...
          { id: 'a2-u9-s2', title: 'Listening: Lost in the City', type: 'listening_task', moduleView: AppView.LISTENING, description: 'A tourist seeking the mosque.', goal: 'Draw a mental map.', promptContext: 'Listen to a local giving directions to the central library.', targetId: 'a2-travel-02' },
      ...
      },
      {
        ...
        steps: [
          ...
          { id: 'a2-u10-s1', title: 'Reading: Historical Hijra', type: 'reading_task', moduleView: AppView.READING, description: 'A story of migration.', goal: 'Sequence events.', promptContext: 'Read about the Prophet PBUH moving to Medina using mixed tenses.', targetId: 'a2-social-03' },
          { id: 'a2-u10-s2', title: 'Listening: A Grand Wedding', type: 'listening_task', moduleView: AppView.LISTENING, description: 'Family gathering details.', goal: 'Summarize events.', promptContext: 'A person describing a beautiful traditional wedding they attended.', targetId: 'a2-social-03' },
    ...
    units: [
      {
        ...
        steps: [
          ...
          { id: 'b1-u1-s2', title: 'Reading: A Scholar\'s Journey', type: 'reading_task', moduleView: AppView.READING, description: 'Reflective biography.', goal: 'Analyze achievements.', promptContext: 'Read about a modern scholar\'s contributions to science and faith.', targetId: 'b1-social-01' },
      ...
      },
      {
        ...
        steps: [
          ...
          { id: 'b1-u2-s2', title: 'Listening: Green Initiatives', type: 'listening_task', moduleView: AppView.LISTENING, description: 'Environmental project updates.', goal: 'Identify durations.', promptContext: 'A speaker talking about how long they have been building wells.', targetId: 'b1-nature-02' },
      ...
      },
      {
        ...
        steps: [
          ...
          { id: 'b1-u3-s2', title: 'Reading: Mosque Architecture', type: 'reading_task', moduleView: AppView.READING, description: 'Historical construction process.', goal: 'Catch passive details.', promptContext: 'Read about how the Great Mosque was built and maintained over centuries.', targetId: 'b1-work-03' },
      ...
      },
      {
        ...
        steps: [
          ...
          { id: 'b1-u4-s2', title: 'Reading: Advice for Youth', type: 'reading_task', moduleView: AppView.READING, description: 'Conditional moral guidance.', goal: 'Find cause/effect links.', promptContext: 'Read a letter from an elder giving conditional advice on life.', targetId: 'b1-education-04' },
      ...
      },
      {
        ...
        steps: [
          ...
          { id: 'b1-u5-s2', title: 'Reading: Role Models', type: 'reading_task', moduleView: AppView.READING, description: 'Biographies of Sahabah.', goal: 'Analyze complex identities.', promptContext: 'Read about the man who stood by the truth in difficult times.', targetId: 'b1-social-05' },
      ...
      },
      {
        ...
        steps: [
          ...
          { id: 'b1-u6-s2', title: 'Listening: The Missing Key', type: 'listening_task', moduleView: AppView.LISTENING, description: 'Detective-style investigation.', goal: 'Draw logical conclusions.', promptContext: 'Listen to two people speculating where their friend could be.', targetId: 'b1-work-06' },
      ...
      },
      {
        ...
        steps: [
          ...
          { id: 'b1-u7-s2', title: 'Reading: From Waste to Wisdom', type: 'reading_task', moduleView: AppView.READING, description: 'A story of life change.', goal: 'Identify old routines.', promptContext: 'Read about a man who used to waste time but now serves others.', targetId: 'b1-akhlak-07' },
      ...
      },
      {
        ...
        steps: [
          ...
          { id: 'b1-u8-s2', title: 'Listening: Planning Eid', type: 'listening_task', moduleView: AppView.LISTENING, description: 'Booking and confirmation details.', goal: 'Capture dates/times.', promptContext: 'Listen to a family organizing an Eid gathering with specific bookings.', targetId: 'b1-work-01' },
      ...
      },
      {
        ...
        steps: [
          ...
          { id: 'b1-u9-s2', title: 'Reading: The Simple Life', type: 'reading_task', moduleView: AppView.READING, description: 'Minimalism and spirituality.', goal: 'Analyze resource words.', promptContext: 'Read about the Sahabah who had little but gave plenty.', targetId: 'b1-righteous-02' },
      ...
      },
      {
        ...
        steps: [
          ...
          { id: 'b1-u10-s2', title: 'Listening: Career Advice', type: 'listening_task', moduleView: AppView.LISTENING, description: 'A mentor-student talk.', goal: 'Capture goals vs enjoyments.', promptContext: 'Listen to a mentor talking about wanting to help and enjoying teaching.', targetId: 'b1-daily-03' },
    ...
    units: [
      {
        ...
        steps: [
          ...
          { id: 'b2-u1-s2', title: 'Reading: Seerah Chapters', type: 'reading_task', moduleView: AppView.READING, description: 'In-depth historical narrative.', goal: 'Analyze complexity.', promptContext: 'Read about the Prophet\'s entry into Mecca after years of exile.', targetId: 'b2-education-01' },
      ...
      },
      {
        ...
        steps: [
          ...
          { id: 'b2-u2-s2', title: 'Reading: If History Were Different', type: 'reading_task', moduleView: AppView.READING, description: 'Alternative history analysis.', goal: 'Evaluate results.', promptContext: 'Read an essay about if certain scholars hadn\'t moved to other lands.', targetId: 'b2-akhlak-02' },
      ...
      },
      {
        ...
        steps: [
          ...
          { id: 'b2-u3-s2', title: 'Listening: Global News', type: 'listening_task', moduleView: AppView.LISTENING, description: 'Developments in Islamic finance.', goal: 'Identify objective sources.', promptContext: 'Listen to a news bulletin about the growth of ethical banking.', targetId: 'b2-technology-03' },
      ...
      },
      {
        ...
        steps: [
          ...
          { id: 'b2-u4-s2', title: 'Reading: Visi 2045', type: 'reading_task', moduleView: AppView.READING, description: 'National and global projections.', goal: 'Identify deadlines.', promptContext: 'Read a vision statement about education in the next 20 years.', targetId: 'b2-work-04' },
      ...
      },
      {
        ...
        steps: [
          ...
          { id: 'b2-u5-s2', title: 'Reading: Letter to Myself', type: 'reading_task', moduleView: AppView.READING, description: 'Poetic reflections.', goal: 'Understand emotional nuances.', promptContext: 'Read a story about a person writing a letter to their younger self.', targetId: 'b2-health-05' },
      ...
      },
      {
        ...
        steps: [
          ...
          { id: 'b2-u6-s2', title: 'Reading: World Heritage', type: 'reading_task', moduleView: AppView.READING, description: 'Islamic heritage sites.', goal: 'Identify extra facts.', promptContext: 'Read about the Alhambra, which was built during the Nasrid dynasty.', targetId: 'b2-technology-06' },
      ...
      },
      {
        ...
        steps: [
          ...
          { id: 'b2-u7-s2', title: 'Listening: The Silent Artifact', type: 'listening_task', moduleView: AppView.LISTENING, description: 'Museum mystery.', goal: 'Draw logical conclusions.', promptContext: 'Listen to archivists speculating how an old manuscript survived.', targetId: 'b2-education-07' },
      ...
      },
      {
        ...
        steps: [
          ...
          { id: 'b2-u8-s2', title: 'Reading: Modern Management', type: 'reading_task', moduleView: AppView.READING, description: 'Effective leadership esays.', goal: 'Identify delegation patterns.', promptContext: 'Read about how a leader had the team redesign the whole system.', targetId: 'b2-work-01' },
      ...
      },
      {
        ...
        steps: [
          ...
          { id: 'b2-u9-s2', title: 'Reading: Intentional Living', type: 'reading_task', moduleView: AppView.READING, description: 'Mindfulness and commitments.', goal: 'Differentiate meanings.', promptContext: 'Read about a man who forgot to pray vs forgot praying.', targetId: 'b2-akhlak-02' },
      ...
      },
      {
        ...
        steps: [
          ...
          { id: 'b2-u10-s2', title: 'Listening: The Scholar\'s Advice', type: 'listening_task', moduleView: AppView.LISTENING, description: 'Recording of a speech.', goal: 'Report the core message.', promptContext: 'Listen to a speech and then report what the speaker said to Lovelya.', targetId: 'b2-social-03' },
    ...
    units: [
      {
        ...
        steps: [
          ...
          { id: 'c1-u1-s2', title: 'Reading: Philosophies of Virtue', type: 'reading_task', moduleView: AppView.READING, description: 'Dense text on character.', goal: 'Map emphasis points.', promptContext: 'Read a profound essay about the rarity of true integrity in modern times.', targetId: 'c1-akhlak-01' },
      ...
      },
      {
        ...
        steps: [
          ...
          { id: 'c1-u2-s2', title: 'Reading: Analyzing Manuscripts', type: 'reading_task', moduleView: AppView.READING, description: 'Civilizational analysis.', goal: 'Find cause/effect ripple.', promptContext: 'If certain libraries hadn\'t been lost, what would be different today?', targetId: 'c1-righteous-02' },
      ...
      },
      {
        ...
        steps: [
          ...
          { id: 'c1-u3-s2', title: 'Listening: Research Path', type: 'listening_task', moduleView: AppView.LISTENING, description: 'Academic journal review.', goal: 'Summarize compactly.', promptContext: 'Listen to a researcher explaining their data analysis results.', targetId: 'c1-akhlak-03' },
      ...
      },
      {
        ...
        steps: [
          ...
          { id: 'c1-u4-s2', title: 'Reading: The Heart of the Matter', type: 'reading_task', moduleView: AppView.READING, description: 'Argumentative essay.', goal: 'Identify main clefts.', promptContext: 'Read a text that clarifies misconceptions about Islamic science.', targetId: 'c1-education-02' },
      ...
      },
      {
        ...
        steps: [
          ...
          { id: 'c1-u5-s2', title: 'Reading: Life of a Sage', type: 'reading_task', moduleView: AppView.READING, description: 'Biographical milestones.', goal: 'Sequence time accumulation.', promptContext: 'Read about a sage who will have been serving for 50 years next year.', targetId: 'c1-righteous-05' },
      ...
      },
      {
        ...
        steps: [
          ...
          { id: 'c1-u6-s2', title: 'Listening: Board Meeting', type: 'listening_task', moduleView: AppView.LISTENING, description: 'Formal organizational talk.', goal: 'Identify 10 concepts.', promptContext: 'Listen to a manager discussing the implementation of character goals.', targetId: 'c1-work-06' },
      ...
      },
      {
        ...
        steps: [
          ...
          { id: 'c1-u7-s2', title: 'Listening: Rapid Debate', type: 'listening_task', moduleView: AppView.LISTENING, description: 'Agile fast-paced talk.', goal: 'Identify missing words.', promptContext: 'Listen to a fast dialogue where speakers skip redundant words.', targetId: 'c1-social-07' },
      ...
      },
      {
        ...
        steps: [
          ...
          { id: 'c1-u8-s2', title: 'Reading: Lost Manuscripts', type: 'reading_task', moduleView: AppView.READING, description: 'Inquiry into forgotten history.', goal: 'Determine likely actions.', promptContext: 'Read about an archive fire and speculate how it might have been starting.', targetId: 'c1-education-01' },
      ...
      },
      {
        ...
        steps: [
          ...
          { id: 'c1-u9-s2', title: 'Reading: Architectural Review', type: 'reading_task', moduleView: AppView.READING, description: 'Detailed design analysis.', goal: 'Match 10 modifiers.', promptContext: 'Read a review of a world-renowned building with custom-designed features.', targetId: 'c1-social-02' },
      ...
      },
      {
        ...
        steps: [
          ...
          { id: 'c1-u10-s2', title: 'Reading: Global Ethics', type: 'reading_task', moduleView: AppView.READING, description: 'Dense argumentative text.', goal: 'Identify logical shifts.', promptContext: 'Read a complex argument about ethics in a digital world.', targetId: 'c1-work-03' },
    ...
    units: [
      {
        ...
        steps: [
          ...
          { id: 'c2-u1-s2', title: 'Reading: Boardroom Resolves', type: 'reading_task', moduleView: AppView.READING, description: 'High-level meeting minutes.', goal: 'Identify mandative forms.', promptContext: 'Read about the imperative resolves for world peace at a global NGO.', targetId: 'c2-work-01' },
      ...
      },
      {
        ...
        steps: [
          ...
          { id: 'c2-u2-s2', title: 'Reading: Keynote Wisdom', type: 'reading_task', moduleView: AppView.READING, description: 'Legendary pidato analysis.', goal: 'Analyze emotional impact.', promptContext: 'Read a speech about unity where inversion builds the tension.', targetId: 'c2-tauhid-02' },
      ...
      },
      {
        ...
        steps: [
          ...
          { id: 'c2-u3-s2', title: 'Reading: Theological Debates', type: 'reading_task', moduleView: AppView.READING, description: 'Dense scholarly argument.', goal: 'Map focus shifts.', promptContext: 'Read a debate wrap-up where clefts establish the final Haqq.', targetId: 'c2-tauhid-03' },
      ...
      },
      {
        ...
        steps: [
          ...
          { id: 'c2-u4-s2', title: 'Reading: Scientific Abstracts', type: 'reading_task', moduleView: AppView.READING, description: 'High-level psychological journals.', goal: 'Map semantic density.', promptContext: 'Read an abstract about the re-evaluation of social trust.', targetId: 'c2-education-04' },
      ...
      },
      {
        ...
        steps: [
          ...
          { id: 'c2-u5-s2', title: 'Reading: Proverbial Wisdom', type: 'reading_task', moduleView: AppView.READING, description: 'Maxims from around the world.', goal: 'Analyze parallel rhythms.', promptContext: 'Read about the correlation between hard work and success in history.', targetId: 'c2-tauhid-05' },
      ...
      },
      {
        ...
        steps: [
          ...
          { id: 'c2-u6-s2', title: 'Listening: Crisis Negotiation', type: 'listening_task', moduleView: AppView.LISTENING, description: 'Fast-paced negotiation room.', goal: 'Decode skipped information.', promptContext: 'Listen to a coordinator and team leading a rapid response.', targetId: 'c2-education-06' },
      ...
      },
      {
        ...
        steps: [
          ...
          { id: 'c2-u7-s2', title: 'Listening: News Commentary', type: 'listening_task', moduleView: AppView.LISTENING, description: 'High-level bulletins.', goal: 'Find passive depth.', promptContext: 'Listen to a commentary about societal transformation.', targetId: 'c2-akhlak-07' },
      ...
      },
      {
        ...
        steps: [
          ...
          { id: 'c2-u8-s2', title: 'Reading: Legacy 2050', type: 'reading_task', moduleView: AppView.READING, description: 'Foundation history from the future.', goal: 'Map duration milestones.', promptContext: 'Read a letter from the future describing our foundation\'s 50-year effort.', targetId: 'c2-work-01' },
      ...
      },
      {
        ...
        steps: [
          ...
          { id: 'c2-u9-s2', title: 'Reading: Legal Contract Review', type: 'reading_task', moduleView: AppView.READING, description: 'Highly technical discourse.', goal: 'Identify 10 modifiers.', promptContext: 'Read a legally-binding agreement about international cooperation.', targetId: 'c2-social-02' },
      ...
      },
      {
        ...
        steps: [
          ...
          { id: 'c2-u10-s2', title: 'Reading: Final Reflections', type: 'reading_task', moduleView: AppView.READING, description: 'Global Scientific Council text.', goal: 'Analyze argument cohesion.', promptContext: 'Read the concluding remarks of a profound international summit.', targetId: 'c2-education-03' },
